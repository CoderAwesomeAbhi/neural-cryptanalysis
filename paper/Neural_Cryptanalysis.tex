...
\begin{table}[ht]
\centering
\caption{Quantitative LLL lattice attack results. Success rate = fraction of sequence terms correctly predicted from shortest lattice vector.}
\label{tab:lattice}
\medskip
\begin{tabular}{@{}lrrrrc@{}}
\toprule
Config & $m$ & Period & Shortest Norm & Success Rate & Resistance\\
\midrule
$p=5$, $k=1$ & 5 & 25 & 2.45 & 89.2\% & LOW\\
$p=5$, $k=2$ & 25 & 212 & 8.73 & 12.4\% & MEDIUM\\
$p=5$, $k=3$ & 125 & 7295 & 24.16 & 2.1\% & HIGH\\
$p=7$, $k=2$ & 49 & 1531 & 15.82 & 5.7\% & HIGH\\
$p=11$, $k=2$ & 121 & 275 & 22.91 & 3.8\% & HIGH\\
$p=13$, $k=2$ & 169 & 910 & 28.34 & 1.9\% & HIGH\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[ht]
\centering
\caption{Ergodicity measures for Hensel-satisfied vs violated configurations.}
\label{tab:ergodicity}
\medskip
\begin{tabular}{@{}lrrrr@{}}
\toprule
Config & $p(\chi^2)$ & Mean$|\mathrm{ACF}|$ & 2-gram cov & $H/H_{\max}$\\
\midrule
\multicolumn{5}{l}{\textit{Hensel-satisfied}}\\
p5k2sat  & 0.842 & 0.043 & 0.94 & 0.998\\
p7k2sat  & 0.721 & 0.051 & 0.91 & 0.996\\
\midrule
\multicolumn{5}{l}{\textit{Hensel-violated}}\\
